...
SAVE_FILE = 'save/n_modelpWtAUG.pt'  # Path to save the trained model (ensure the 'save' folder exists)
...
SRC_VOCAB = 11487 # Vocabulary size for the source language (e.g., English)
TGT_VOCAB = 22200  # Vocabulary size for the target language (e.g., Telugu)

# Paths for BLEU score evaluation (specific to DEV file)
BLEU_REFERENCES = "bleu/reference.txt"  # Reference translations for BLEU evaluation
BLEU_CANDIDATE = "bleu/candidate.txt"  # Candidate translations generated by the model
